...
santaImage1 = openImage('santa1.png') 
...
### Tools
app.hammerImage = openImage('hammer.png') # credit: https://www.shutterstock.com/search/cartoon-hammer
app.hammerImage = CMUImage(app.hammerImage)

app.glueImage = openImage('glue.png') # credit: https://depositphotos.com/vector/cartoon-glue-bottle-59808127.html
app.glueImage = CMUImage(app.glueImage)

app.ovenImage = openImage('oven.png') # credit: https://www.istockphoto.com/vector/burning-brick-fireplace-with-fire-classic-indoor-chimney-in-traditional-style-with-gm1343026291-422046383
app.ovenImage = CMUImage(app.ovenImage)

app.knitImage = openImage('knit.png') # credit: https://www.seekpng.com/ipng/u2q8a9r5t4i1y3a9_knitting-needle-png-knitting-needles-transparent/
...
app.shelfImage = openImage('shelf.png') #credit: https://thehungryjpeg.com/product/3498125-empty-wall-book-shelf-wood-shelves-vector-illustration
app.shelfImage = CMUImage(app.shelfImage)

app.tableImage = openImage('table.png') #credit: https://www.vecteezy.com/vector-art/1742378-wooden-table-top
app.tableImage = CMUImage(app.tableImage)

app.workbenchImage = openImage('workbench.png') # credit: https://www.istockphoto.com/vector/wooden-table-on-white-background-gm657723786-119947237
app.workbenchImage = CMUImage(app.workbenchImage)

fireImage = openImage('fire.gif') # credit: https://gifer.com/en/gifs/fire
app.fireImages = []
...
app.bookImage = openImage('book.png') # credit: https://www.clipartmax.com/middle/m2i8i8G6H7H7m2H7_clip-art-old-book-open-book-png/
app.bookImage = CMUImage(app.bookImage)


### Trash can

app.trashImage = openImage('trash.png') #credit: https://www.pinterest.com/pin/787355947343009144/
app.trashImage = CMUImage(app.trashImage)


#### Other

app.giftImage = openImage('gift.png') # credit: https://www.cleanpng.com/png-blue-computer-icons-gift-clip-art-4116009/
app.giftImage = CMUImage(app.giftImage)

app.wreathImage = openImage('wreath.png')
