...
def drawHouses(app):
    ...
    for house in app.houses:
        ...
        drawImage(housePics[house.number], houseX+app.cellWidth/2, houseY+app.cellHeight/2 + 2, width=app.houseImageWidth, height=app.houseImageHeight, align='center')
     ...
     if app.screen == 'default-screen':
        for house in app.houses:
            if house.gift != None:
                ...
                drawImage(gift, labelX, labelY, width=app.giftImageWidth/2, height=app.giftImageHeight/2, align='center')
...
def drawRecipeBook(app):
    ...
    for recipe in app.recipes:
        ...
        drawImage(gift, app.width/8+100, app.height/8+10+60*i, width=app.giftImageWidth, height=app.giftImageHeight, align='right')
        j = 1
        for material in app.recipes[recipe]:
            if material != 'tool':
                ...
                drawLabel(f'Use the {app.recipes[recipe][material]}', app.width/2+3*app.width/8-10, app.height/8+10+60*i, size=15, align='right')
            j+=1
        i+=1 
